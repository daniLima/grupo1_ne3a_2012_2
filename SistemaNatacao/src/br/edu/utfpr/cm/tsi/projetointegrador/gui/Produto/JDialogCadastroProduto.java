...
private void jButtonConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConfirmarActionPerformed
    int n = JOptionPane.showConfirmDialog(rootPane, "Deseja Cadastar o Produto: " + NomeText.getText());
    if (n == 0) {
...
private void ObservacoesTextAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_ObservacoesTextAncestorAdded
    ...
    public static List buscar(String codigo, String nome, String descricao, String quantidade, String observacao) {
        List lista = null;
