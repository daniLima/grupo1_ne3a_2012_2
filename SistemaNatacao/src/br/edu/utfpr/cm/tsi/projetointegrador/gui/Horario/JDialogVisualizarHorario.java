...
public class JDialogVisualizarHorario extends javax.swing.JDialog {
     ...
     */
    public JDialogVisualizarHorario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogVisualizarHorario dialog = new JDialogVisualizarHorario(new javax.swing.JFrame(), true);
